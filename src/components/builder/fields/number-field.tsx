...
const type: ElementsType = "NumberField" as const;
...
export const createNumberFieldElement = (dictionary: Dictionary) => ({
  type,
  construct: (id: string) => ({
    id,
    type,
    extraAttributes: {
      label: dictionary["form-elements"].number["extra:label"],
      helperText: dictionary["form-elements"].number["extra:helper"],
      placeHolder: "0",
      required: false
    }
  }),
  designerButtonElement: {
    icon: Bs123,
    label: dictionary["form-elements"].number["icon:label"]
  },
