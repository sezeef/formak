...
const type: ElementsType = "DateField" as const;
...
export const createDateFieldElement = (dictionary: Dictionary) => ({
  type,
  construct: (id: string) => ({
    id,
    type,
    extraAttributes: {
      label: dictionary["form-elements"].date["extra:label"],
      helperText: dictionary["form-elements"].date["extra:helper"],
      required: false
    }
  }),
  designerButtonElement: {
    icon: BsFillCalendarDateFill,
    label: dictionary["form-elements"].date["icon:label"]
  },
  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      ...
      >
        ...
        <span>{dictionary["form-elements"].date["designer:label:label"]}</span>
      </Button>
      {helperText && (
